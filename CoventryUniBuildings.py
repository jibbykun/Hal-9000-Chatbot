...
async def on_message(message):
    ...
    if covcheck in keyword_list:
        ...
        await client.send_message(message.channel, "Would like to know about the Coventry University Buildings?")

    elif message.content == "YES" or message.content == "WHY NOT" or message.content == "SURE":
    ...
    elif message.content == "ALAN BERRY":
    ...
    elif message.content == "ARMSTRONG SIDDELEY":
    ...
    elif message.content == "CHARLES WARD":
    ...
    elif message.content == "ENGINEERING & COMPUTING BUILDING":
    ...
    elif message.content == "ELLEN TERRY":
    ...
    elif message.content == "GEORGE ELLIOT":
    ...
    elif message.content == "GRAHAM SUTHERLAND":
    ...
    elif message.content == "FREDERICK LANCHESTER LIBRARY":
    ...
    elif message.content == "MAURICE FOSS":
    ...
    elif message.content == "JAMES STARLEY":
    ...
    elif message.content == "MULTI-STOREY CAR PARK":
    ...
    elif message.content == "PRIORY BUILDING":
    ...
    elif message.content == "RICHARD CROSSMAN":
    ...
    elif message.content == "ALISON GINGELL BUILDING":
    ...
    elif message.content == "SIR JOHN LANG":
    ...
    elif message.content == "SIR WILLIAM LYONS":
    ...
    elif message.content == "STUDENT CENTRE":
    ...
    elif message.content == "WHITEFRIARS":
    ...
    elif message.content == "WILLIAM MORRIS":
    ...
    elif message.content == "SPORTS CENTRE":
